  ...
  >
    ...
    <div className="relative p-6">
      ...
      <div className="relative">
        ...
        {stats && (
          <div className="text-4xl font-bold bg-gradient-to-r from-emerald-800 via-emerald-600 to-emerald-400 bg-clip-text text-transparent">
            {stats}
          </div>
        )}
      </div>
...
function About() {
  ...
  return (
    <section className="relative min-h-screen py-20 overflow-hidden bg-gradient-to-b from-emerald-50 via-white to-emerald-50" id='about'>
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-emerald-100 rounded-full -translate-x-1/2 -translate-y-1/2 opacity-30" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-emerald-100 rounded-full translate-x-1/2 translate-y-1/2 opacity-30" />
      ...
      >
        ...
        >
          <h1 className="text-6xl font-bold bg-gradient-to-r from-emerald-800 via-emerald-600 to-emerald-400 bg-clip-text text-transparent inline-block mb-6">
            About Green Janitors
            <span className="block text-4xl mt-2">Sustainable Initiative</span>
          </h1>
          <div className="w-32 h-1 bg-gradient-to-r from-emerald-800 via-emerald-600 to-emerald-400 mx-auto rounded-full mb-8" />
          <p className="text-xl text-emerald-700 slide-left max-w-3xl mx-auto leading-relaxed">
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <h2 className="text-4xl font-bold text-center text-emerald-800 mb-12">Our Values</h2>
          <div className="grid md:grid-cols-3 slide-right gap-8">
        ...
        <motion.div variants={itemVariants}>
          <h2 className="text-4xl font-bold text-center text-emerald-800 mb-12">Our Impact</h2>
          <div className="grid md:grid-cols-3 slide-left gap-8">
      ...
      {[...Array(5)].map((_, i) => (
        <motion.div
          key={i}
          className={`absolute w-${i + 2} h-${i + 2} bg-emerald-${200 + i * 100} rounded-full`}
          style={{
            left: `${Math.random() * 90}%`,
            top: `${Math.random() * 90}%`,
          }}
